...
Write-Host ""
Write-Host "The archive task prunes exports older than 30 days, as SYSTEM. Nothing unelevated"
Write-Host "can remove or change anything in here, including the rule: the task runs the copy"
Write-Host "of archive-backups.ps1 inside the archive, which only re-running this script"
Write-Host "elevated refreshes."
