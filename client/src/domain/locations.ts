 ...
 *
 * matchLocationTier() matches a rule's terms as lowercase substrings of a posting's location,
 * and postings spell places many ways ("Remote (U.S.)", "USA - Remote"). So a
